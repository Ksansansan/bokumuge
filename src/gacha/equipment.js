...
export const EQUIP_NAMES = {
  str:["朽ちた木の枝", "兵士の銅剣", "業物の鉄剣", "銀騎士の長剣", "勇者の聖剣", "覇王の宝剣", "魔剣グラム", "聖剣エクスカリバー", "神槍グングニル", "終焉の魔剣レーヴァテイン", "創世剣・天地開闢", "次元断層の刃", "始まりの創造神剣"],
  vit:["ボロボロの布服", "なめし革の鎧", "鋼鉄の重鎧", "ミスリルの鎖帷子", "王家の紋章鎧", "オリハルコンの神鎧", "聖盾アイギス", "竜神の逆鱗鎧", "天使の神衣", "冥王の絶望鎧", "神の威光", "絶対結界アヴァロン", "無限宇宙の神装"],
  agi:["すり減ったわらじ", "旅人の革靴", "しなやかな風切靴", "銀細工の飛燕靴", "天馬の疾風靴", "星渡りの天靴", "閃光のヘルメスブーツ", "光速のフェンリルブーツ", "天駆けの光翼靴", "虚空を歩む靴", "超光速の神靴", "時空跳躍のブーツ", "概念超越の歩界"],
  lck:["石ころの指輪", "欠けた銅の指輪", "水晶のペンダント", "魔力宿るアミュレット", "精霊の涙", "竜の心臓", "時の歯車", "賢者の石", "星屑の指輪", "宇宙の真理", "神格の証", "特異点の核", "ぼくらの無限塔"]
};
